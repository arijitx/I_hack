...
* request_info{"info": "address"}
 - action_suggest
* place_order{"food": "butter chicken"}
 - utter_ack_makereservation
* affirm
 - utter_placeorder
* thankyou
...
* request_info{"info": "address"}
 - action_suggest
* place_order{"food": "hakka noodles"}
 - utter_ack_makereservation
* affirm
 - utter_placeorder
* thankyou
...
* greet
 - utter_ask_howcanhelp
* request_info{"order_id": "K5349879"}
 - utter_order_details
* thankyou
 - utter_ask_helpmore
...
* greet
 - utter_ask_howcanhelp
* add_to_order{"food": "butter chicken"}
 - utter_addtoorder
* thankyou
 - utter_ask_helpmore
